...
(defsystem #:montezuma
    ...
    :depends-on (#:cl-ppcre #:cl-fad #:babel #:osicat #:info.read-eval-print.mecab #:bordeaux-threads)
    :components
    ((:module "src"
	:components
	((:file "package")
	 ...
	 (:module "analysis"
		  :components ((:file "token")
			       ...
			       (:file "analyzers"           :depends-on ("standard-tokenizer"))
                               (:file "mecab-analyzer"      :depends-on ("standard-tokenizer")))
